          ...
          <div>
            ...
            <span className="flex flex-col">
              ...
              <div className="flex max-[1200px]:flex-col gap-2">
                {/* Инпут и кнопка с адаптивными размерами */}
                <Input className="min-w-[1200px]:w-[350px] w-full min-[2000px]:text-xl min-[2500px]:text-2xl" placeholder="Enter your email" />
                <Button className="text-xs min-[1267px]:text-sm min-[1500px]:text-base min-[2000px]:text-2xl min-[2500px]:text-3xl">
