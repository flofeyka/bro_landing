    ...
    return (
        ...
        <span className="text-6xl whitespace-pre-line font-semibold  text-end">
          ...
          <span className="text-[#2F7FAA]">{t('hero.everydaySecure')}</span>
                ...
                <span>
          <img src="/images/lock.jpg" className="w-[325px] rounded-2xl" alt="lock" />
        </span>
            </div>

            <div className="flex items-center gap-10 w-full">
        <span>
          <img src="/images/safe_bitcoin.jpg" className="w-[325px] rounded-2xl" alt="safe bitcoin" />
        </span>

                <span className="flex flex-col items-end">
          <div className="flex gap-2 max-w-[450px] items-center">
            <span className="text-[120px] h-[200px] font-light text-[#2F7FAA]">[</span>
