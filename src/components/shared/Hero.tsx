...
export default function HeroSection() {
    ...
    return (<main className="flex flex-col justify-center">
        <div
            className="grid min-[1200px]:grid-cols-[1fr_1.11fr] max-[768px]:grid-rows-2 items-center w-full justify-center">
            <div>
                {/* Главный заголовок */}
                <span
                    className="text-5xl max-sm:text-4xl min-[2000px]:text-6xl min-[2500px]:text-7xl whitespace-pre-line font-semibold text-end">
            ...
            <span className="flex flex-col">
              ...
              <div className="flex max-[1200px]:flex-col gap-2">
                  <Input className="min-w-[1200px]:w-[350px] w-full min-[2000px]:text-xl min-[2500px]:text-2xl"
                         placeholder="Enter your email"/>
                <a href={'request'} className={'max-sm:w-full'}>
                    <Button
                        className="text-xs min-[1267px]:text-sm min-[1500px]:text-base min-[2000px]:text-2xl min-[2500px]:text-3xl max-sm:w-full">
